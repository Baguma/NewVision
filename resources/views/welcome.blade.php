...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ asset('css/circle.css') }}">
    ...
    <script>
        window.addEventListener('load', function() {
            var circleB = document.querySelector('.circle-b');
            ...
            setInterval(function() {
                var centerX_B = circleB.offsetWidth / 2;
                var centerY_B = circleB.offsetHeight / 2;

                var x_B = centerX_B + Math.cos(angleB) * radiusB - dot2.offsetWidth / 2;
                var y_B = centerY_B + Math.sin(angleB) * radiusB - dot2.offsetHeight / 2;

                var x_B1 = centerX_B + Math.cos(angleB1) * radiusB - dot3.offsetWidth / 2;
                var y_B1 = centerY_B + Math.sin(angleB1) * radiusB - dot3.offsetHeight / 2;

                dot2.style.left = x_B + 'px';
                dot2.style.top = y_B + 'px';

                dot3.style.left = x_B1 + 'px';
                dot3.style.top = y_B1 + 'px';
